...
function BusinessLicenseUpload() {
  return (
    <AnimatedPressable onPress={() => Alert.alert('안내', '사업자등록증 첨부 기능은 준비중입니다.')} className="mt-5 items-center rounded-[22px] border border-dashed border-petal bg-blush px-4 py-7">
      ...
      <Text className="mt-3 text-[12px] font-black text-ink">사업자등록증 첨부</Text>
      <Text className="mt-1 text-center text-[9px] leading-5 text-muted">이미지 또는 PDF 파일을 첨부할 수 있어요.</Text>
      <View className="mt-4 rounded-full bg-white px-3 py-2"><Text className="text-[9px] font-black text-berry">파일 추가</Text></View>
          ...
          <View className="px-5">
            <FadeInView delay={50}>
              <View className="mt-4 rounded-[26px] bg-white p-5 shadow-sm">
                <Text className="text-[10px] font-black text-berry">BREEDER TYPE</Text>
                <Text className="mt-1 text-[19px] font-black text-ink">브리더 유형 선택</Text>
            ...
            <FadeInView delay={90}>
              <View className="mt-4 rounded-[26px] bg-white p-5 shadow-sm">
                <Text className="text-[10px] font-black text-berry">BREEDER INFO</Text>
            ...
            {breederType === 'business' ? (
              <FadeInView delay={110}>
                <View className="mt-4 rounded-[26px] bg-white p-5 shadow-sm">
                  <Text className="text-[10px] font-black text-berry">BUSINESS INFO</Text>
                  <Text className="mt-1 text-[19px] font-black text-ink">사업자 정보</Text>
            ...
            <FadeInView delay={130}>
              <View className="mt-4 rounded-[26px] bg-white p-5 shadow-sm">
                <Text className="text-[10px] font-black text-berry">ENVIRONMENT</Text>
                <Text className="mt-1 text-[19px] font-black text-ink">사육 환경 인증</Text>
            ...
            <FadeInView delay={170}>
              <View className="mt-4 rounded-[26px] bg-white p-5 shadow-sm">
                <Text className="text-[10px] font-black text-berry">AGREEMENT</Text>
                <Text className="mt-1 text-[19px] font-black text-ink">신청 전 확인해 주세요</Text>
