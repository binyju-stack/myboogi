      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="pb-16">
        <FadeInView>
          <View className="bg-white px-5 pb-7 pt-5">
            {notice.important ? <Text className="self-start rounded-full bg-blush px-3 py-2 text-[10px] font-bold text-berry">중요 공지</Text> : null}
            <Text className="mt-4 text-[24px] font-bold leading-9 text-ink">{notice.title}</Text>
