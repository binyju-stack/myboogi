  ...
  return (
    <Page>
      ...
      <View className="bg-white px-5 pb-6 pt-4">
        <Text className="text-[10px] font-bold text-berry">BLOCKED USERS</Text>
        <Text className="mt-1 text-[24px] font-bold text-ink">차단 목록을 관리해요</Text>
            ...
            <View className="mb-3 rounded-[24px] border border-line bg-white p-4 shadow-sm">
              <View className="flex-row items-center">
                ...
                <View className="ml-3 flex-1">
                  <Text className="text-[13px] font-bold text-ink">{user.nickname}</Text>
                ...
                <AnimatedPressable onPress={() => Alert.alert('차단 해제 기능은 준비중입니다.')} className="rounded-full bg-blush px-3.5 py-2.5">
                  <Text className="text-[10px] font-bold text-berry">차단 해제</Text>
                </AnimatedPressable>
              </View>
            </View>
          </FadeInView>
