  ...
  return (
    <SafeAreaView className="flex-1 bg-page">
      <View className="flex-row items-center bg-white px-4 py-3.5">
        ...
        <Text className="flex-1 text-center text-[16px] font-bold text-ink">분양글 등록</Text>
        <Pressable onPress={() => showReady('임시저장 기능은 준비중입니다.')} className="h-10 min-w-16 items-center justify-center"><Text className="text-[11px] font-bold text-berry">임시저장</Text></Pressable>
      </View>
      ...
      <View className="absolute bottom-0 left-0 right-0 border-t border-line bg-white px-5 py-3">
        <Pressable onPress={() => showReady(`분양글 등록 기능은 준비중입니다.\n${xpMessages.listing}`)} className="items-center rounded-[18px] bg-berry py-4"><Text className="text-[14px] font-bold text-white">분양글 등록하기</Text></Pressable>
      </View>
