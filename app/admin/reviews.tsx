            ...
            <View className="mb-3 rounded-[22px] border border-line bg-white p-4 shadow-sm">
              <View className="flex-row items-start justify-between">
                <View className="flex-1 pr-3">
                  <Text className="text-[13px] font-bold text-ink">{review.author}</Text>
              ...
              <View className="mt-3 flex-row flex-wrap items-center">
                ...
                <View className={`ml-2 rounded-full px-2.5 py-1.5 ${bgClass}`}>
                  <Text className={`text-[9px] font-bold ${textClass}`}>{reviewStatusLabels[review.status]}</Text>
                </View>
