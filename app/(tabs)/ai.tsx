  ...
  return (
    <Page>
      <View className="flex-row items-center bg-white px-5 py-4">
        ...
        <View className="ml-3 flex-1"><Text className="text-[17px] font-black text-ink">부기 AI 상담</Text><View className="mt-1 flex-row items-center"><View className="mr-1.5 h-2 w-2 rounded-full bg-moss" /><Text className="text-[10px] text-muted">지금 상담 가능해요</Text></View></View>
      ...
      <View className="px-5 pt-5">
        <Text className="mb-3 text-[11px] font-black text-muted">많이 묻는 질문</Text>
